...
// 数据来源：通行本《周易》卦爻辞 + 京房八宫世应。lines 自下而上，true=阳。
// 世应：京房八宫，本宫世6、一世世1、二世世2、三世世3、四世世4、五世世5、游魂世4、归魂世3；
// 应 = ((世-1+3)%6)+1（世6→应3、世1→应4、世2→应5、世3→应6、世4→应1、世5→应2）。
export const hexagrams: HexagramData[] = [
  {
    order: 1, name: '乾为天', symbol: '䷀', upper: '乾', lower: '乾',
  ...
  {
    order: 2, name: '坤为地', symbol: '䷁', upper: '坤', lower: '坤',
  ...
  {
    order: 3, name: '水雷屯', symbol: '䷂', upper: '坎', lower: '震',
  ...
  {
    order: 4, name: '山水蒙', symbol: '䷃', upper: '艮', lower: '坎',
  ...
  {
    order: 5, name: '水天需', symbol: '䷄', upper: '坎', lower: '乾',
  ...
  {
    order: 6, name: '天水讼', symbol: '䷅', upper: '乾', lower: '坎',
  ...
  {
    order: 7, name: '地水师', symbol: '䷆', upper: '坤', lower: '坎',
  ...
  {
    order: 8, name: '水地比', symbol: '䷇', upper: '坎', lower: '坤',
  ...
  {
    order: 9, name: '风天小畜', symbol: '䷈', upper: '巽', lower: '乾',
  ...
  {
    order: 10, name: '天泽履', symbol: '䷉', upper: '乾', lower: '兑',
  ...
  {
    order: 11, name: '地天泰', symbol: '䷊', upper: '坤', lower: '乾',
  ...
  {
    order: 12, name: '天地否', symbol: '䷋', upper: '乾', lower: '坤',
  ...
  {
    order: 13, name: '天火同人', symbol: '䷌', upper: '乾', lower: '离',
  ...
  {
    order: 14, name: '火天大有', symbol: '䷍', upper: '离', lower: '乾',
  ...
  {
    order: 15, name: '地山谦', symbol: '䷎', upper: '坤', lower: '艮',
  ...
  {
    order: 16, name: '雷地豫', symbol: '䷏', upper: '震', lower: '坤',
  ...
  {
    order: 17, name: '泽雷随', symbol: '䷐', upper: '兑', lower: '震',
  ...
  {
    order: 18, name: '山风蛊', symbol: '䷑', upper: '艮', lower: '巽',
  ...
  {
    order: 19, name: '地泽临', symbol: '䷒', upper: '坤', lower: '兑',
  ...
  {
    order: 20, name: '风地观', symbol: '䷓', upper: '巽', lower: '坤',
  ...
  {
    order: 21, name: '火雷噬嗑', symbol: '䷔', upper: '离', lower: '震',
  ...
  {
    order: 22, name: '山火贲', symbol: '䷕', upper: '艮', lower: '离',
  ...
  {
    order: 23, name: '山地剥', symbol: '䷖', upper: '艮', lower: '坤',
  ...
  {
    order: 24, name: '地雷复', symbol: '䷗', upper: '坤', lower: '震',
  ...
  {
    order: 25, name: '天雷无妄', symbol: '䷘', upper: '乾', lower: '震',
  ...
  {
    order: 26, name: '山天大畜', symbol: '䷙', upper: '艮', lower: '乾',
  ...
  {
    order: 27, name: '山雷颐', symbol: '䷚', upper: '艮', lower: '震',
  ...
  {
    order: 28, name: '泽风大过', symbol: '䷛', upper: '兑', lower: '巽',
  ...
  {
    order: 29, name: '坎为水', symbol: '䷜', upper: '坎', lower: '坎',
  ...
  {
    order: 30, name: '离为火', symbol: '䷝', upper: '离', lower: '离',
  ...
  {
    order: 31, name: '泽山咸', symbol: '䷞', upper: '兑', lower: '艮',
  ...
  {
    order: 32, name: '雷风恒', symbol: '䷟', upper: '震', lower: '巽',
  ...
  {
    order: 33, name: '天山遯', symbol: '䷠', upper: '乾', lower: '艮',
  ...
  {
    order: 34, name: '雷天大壮', symbol: '䷡', upper: '震', lower: '乾',
  ...
  {
    order: 35, name: '火地晋', symbol: '䷢', upper: '离', lower: '坤',
  ...
  {
    order: 36, name: '地火明夷', symbol: '䷣', upper: '坤', lower: '离',
  ...
  {
    order: 38, name: '火泽睽', symbol: '䷥', upper: '离', lower: '兑',
  ...
  {
    order: 39, name: '水山蹇', symbol: '䷦', upper: '坎', lower: '艮',
  ...
  {
    order: 40, name: '雷水解', symbol: '䷧', upper: '震', lower: '坎',
  ...
  {
    order: 41, name: '山泽损', symbol: '䷨', upper: '艮', lower: '兑',
  ...
  {
    order: 42, name: '风雷益', symbol: '䷩', upper: '巽', lower: '震',
  ...
  {
    order: 43, name: '泽天夬', symbol: '䷪', upper: '兑', lower: '乾',
  ...
  {
    order: 44, name: '天风姤', symbol: '䷫', upper: '乾', lower: '巽',
  ...
  {
    order: 45, name: '泽地萃', symbol: '䷬', upper: '兑', lower: '坤',
  ...
  {
    order: 46, name: '地风升', symbol: '䷭', upper: '坤', lower: '巽',
  ...
  {
    order: 47, name: '泽水困', symbol: '䷮', upper: '兑', lower: '坎',
  ...
  {
    order: 48, name: '水风井', symbol: '䷯', upper: '坎', lower: '巽',
  ...
  {
    order: 49, name: '泽火革', symbol: '䷰', upper: '兑', lower: '离',
  ...
  {
    order: 50, name: '火风鼎', symbol: '䷱', upper: '离', lower: '巽',
  ...
  {
    order: 51, name: '震为雷', symbol: '䷲', upper: '震', lower: '震',
  ...
  {
    order: 52, name: '艮为山', symbol: '䷳', upper: '艮', lower: '艮',
  ...
  {
    order: 53, name: '风山渐', symbol: '䷴', upper: '巽', lower: '艮',
  ...
  {
    order: 54, name: '雷泽归妹', symbol: '䷵', upper: '震', lower: '兑',
  ...
  {
    order: 55, name: '雷火丰', symbol: '䷶', upper: '震', lower: '离',
  ...
  {
    order: 57, name: '巽为风', symbol: '䷸', upper: '巽', lower: '巽',
  ...
  {
    order: 58, name: '兑为泽', symbol: '䷹', upper: '兑', lower: '兑',
  ...
  {
    order: 59, name: '风水涣', symbol: '䷺', upper: '巽', lower: '坎',
  ...
  {
    order: 60, name: '水泽节', symbol: '䷻', upper: '坎', lower: '兑',
  ...
  {
    order: 61, name: '风泽中孚', symbol: '䷼', upper: '巽', lower: '兑',
  ...
  {
    order: 62, name: '雷山小过', symbol: '䷽', upper: '震', lower: '艮',
  ...
  {
    order: 63, name: '水火既济', symbol: '䷾', upper: '坎', lower: '离',
  ...
  {
    order: 64, name: '火水未济', symbol: '䷿', upper: '离', lower: '坎',
